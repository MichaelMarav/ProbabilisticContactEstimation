...
#     plt.plot(time,probs)#! /usr/bin/env python3
...
def stable_contact_detection(ax,ay,az,wx,wy,wz):
    ...
    probs_ax[0:batch_size] =  prob_ax
    probs_ay[0:batch_size] =  prob_ay
    probs_az[0:batch_size] =  prob_az
    probs_wx[0:batch_size] =  prob_wx
    probs_wy[0:batch_size] =  prob_wy
    probs_wz[0:batch_size] =  prob_wz
    ...
    for i in range(batch_size,ax.shape[0],stride):
        ...
        probs_ax[(i-batch_size):i] =  prob_ax
        probs_ay[(i-batch_size):i] =  prob_ay
        probs_az[(i-batch_size):i] =  prob_az
        probs_wx[(i-batch_size):i] =  prob_wx
        probs_wy[(i-batch_size):i] =  prob_wy
        probs_wz[(i-batch_size):i] =  prob_wz
    return probs_ax,probs_ay,probs_az,probs_wx,probs_wy,probs_wz
...
if __name__ == "__main__":
    ...
    probs_ax,probs_ay,probs_az,probs_wx,probs_wy,probs_wz = stable_contact_detection(foot_ax,foot_ay,foot_az,foot_wx,foot_wy,foot_wz)
    ...
    axs[7].scatter(time,probs_ax*probs_ax*probs_ay*probs_az*probs_wx*probs_wy*probs_wz,c='g',s=5)  
